...
class MetaBox extends WordPressObject
{
    ...
    public function saveMetaBox($postId)
    {
        ...
        foreach ($_POST as $key => $value) {
            ...
            if (strpos($key, "checkbox-default-spf-meta-") !== false) {
                $newKey = str_replace('checkbox-default-', '', $key);
     ...
     * @param string $default Default value to use when the box isn't checked.
     *
     * @return void
     */
    public static function CheckboxInput($name, $slug, $value, $default = '')
    {
        $viewData = array(
            'name'    => $name,
            'slug'    => $slug,
    ...
    /**
     * View helper to output a file HTML input field.
     *
     * @since 5.0.0
     *
     * @param string $name Display name for the input field. Used as the label.
     ...
     * @return void
     */
    public static function FileInput($name, $slug)
    {
        self::ViewHelper($name, $slug, 'file');
    }
    ...
    /**
     * View helper to output a time HTML input field.
     *
     * @since 5.0.0
     *
     * @param string $name Display name for the input field. Used as the label.
     ...
     * @return void
     */
    public static function TimeInput($name, $slug)
    {
        self::ViewHelper($name, $slug, 'time');
    }
